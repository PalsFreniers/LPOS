...
%if FILESYSTEM==fat12 || FILESYSTEM==fat16 || FILESYSTEM==fat32
    ...
    %if FILESYSTEM==fat32
        fat32_sect_per_fat:         dd 0
        fat32_flags:                dw 0
        fat32_fat_version_num:      dw 0
    ...
    ebr_volume_label:           db "LPOS     OS"        ; 11 bytes, padded with spaces
...
disk_read:
    ...
    ; whith extention
    mov [ext_DAP.lba], eax
    mov [ext_DAP.segment], es
    mov [ext_DAP.offset], bx
    mov [ext_DAP.count], cl
    mov ah, 0x42
    mov si, ext_DAP
