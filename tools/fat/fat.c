...
bool readSectors(FILE* disk, uint32_t lba, uint32_t count, void* bufferOut) { return (!fseek(disk, lba * g_BootSector.BytesPerSector, SEEK_SET)) && (fread(bufferOut, g_BootSector.BytesPerSector, count, disk) == count); }
